					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">add exam type</li>
							</ol>
						</nav>
					</div>
				</div>
                       ...
                       <form method="post" action="{{route('exam_type.store')}}">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" class="form-control" required placeholder="Exam Type" value=" Exam"> 
                                    @error('name')
