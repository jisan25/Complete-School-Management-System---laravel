                ...
                <div class="col-12">
                    ...
                    <div class="box">
                       <div class="box-header with-border">
                         <h3 class="box-title">Class Assign Subject</h3>
                               ...
                               <tbody>
                                @foreach($data as $key => $value)
                                   <tr>
                                       ...
                                       <td>
                                        <a href="{{route('assign_subject.edit',$value->class_id)}}" class="btn btn-info">Edit</a>
                                        <a href="{{route('assign_subject.show',$value->class_id)}}" class="btn btn-primary">Details</a>
                                       </td>
                                   </tr>
                                  @endforeach
