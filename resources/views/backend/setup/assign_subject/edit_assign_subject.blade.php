            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form method="post" action="{{route('assign_subject.update', $data[0]->class_id)}}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="full_mark[]" class="form-control" required value="{{$item->full_mark}}"> 
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" name="pass_mark[]" class="form-control" required value="{{$item->pass_mark}}"> 
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" name="subjective_mark[]" class="form-control" required value="{{$item->subjective_mark}}"> 
