...
<div class="content-wrapper">
            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form method="post" action="{{route('fee_amount.update', $data[0]->fee_category_id)}}">
                        @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="controls">
                                  <input type="text" name="amount[]" class="form-control" required placeholder="" value="{{ $item->amount }}"> 
    ...
    </div> <!-- end delete whole extra item add -->
                        @endforeach
                        </div> <!-- end add-item -->
