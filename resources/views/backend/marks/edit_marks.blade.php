...
<div class="col-md-3">
        ...
        <div class="form-group">
            <h5>Exam Types <span class="text-danger"> </span></h5>
            <div class="controls">
 ...
 <div class="row d-none" id="marks-entry">
  ...
  <script type="text/javascript">
    $(document).on('click','#search',function(){
      ...
      var subject = $('#'+assign_subject_id).text();
      var exam_type_id = $('#exam_type_id').val();
       $.ajax({
        url: "{{ route('marks.getstudents.edit')}}",
        type: "GET",
        ...
        success: function (data) {
          ...
          $.each( data, function(key, v){
            ...
            '<td width="15%"><input type="text" class="form-control form-control-sm" name="marks[]" value="'+v.marks+'"></td>'+
            '</tr>';
          });
    ...
    $(function(){
      $(document).on('change','#class_id',function(){
        ...
        $.ajax({
          ...
          success:function(data){
            var html = '<option selected disabled value="">Select Subject</option>';
            $.each( data, function(key, v) {
              html += '<option id="'+v.id+'" value="'+v.id+'">'+v.get_subject.name+'</option>';
            });
