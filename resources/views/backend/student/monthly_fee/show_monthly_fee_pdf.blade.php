...
<title>{{ $data->student->name. ' - '  . $month . ' - Month Fee Details'}} </title>
</head>
<body>

@php
$registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id', '1')->where('class_id', $data->class_id)->first();
...
@endphp
  ...
  <table id="customers">
    <tr style="text-align: center">
      ...
      <td>
        <img src="{{public_path('upload/students/'.$data['student']['image'])}}" width="60px" alt="image">  
