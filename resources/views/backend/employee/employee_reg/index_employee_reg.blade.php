                               ...
                               <tbody>
                                @foreach($data as $key => $value)
                                   <tr>
                                       ...
                                       @endif
                                       <td>
                                        <a href="{{route('employee.reg.edit', $value->id)}}" class="btn btn-info">Edit</a>
                                        <a target="_blank" href="{{route('employee.reg.show', $value->id)}}" class="btn btn-success">Details</a>
                                       </td>
                                   </tr>
                                  @endforeach
