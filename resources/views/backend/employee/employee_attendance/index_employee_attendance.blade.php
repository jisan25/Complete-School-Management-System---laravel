                ...
                <div class="col-12">
                    ...
                    <div class="box">
                       <div class="box-header with-border">
                         ...
                         <a href="{{route('employee.attendance.create')}}" style="float: right;" class="btn btn-rounded btn-success mb-5">Add Attendance</a>
                       </div>
                       <!-- /.box-header -->
                       <div class="box-body">
                                ...
                                @foreach($data as $key => $value)
                                   <tr>
                                       ...
                                       <td>
                                        ...
                                        <a href="{{route('employee.attendance.show', $value->date)}}" class="btn btn-success">Details</a>
                                       </td>
                                   </tr>
                                  @endforeach
